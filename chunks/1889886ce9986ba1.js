(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
          ...
          ((this.subscribe = (t) => (
            ...
            (this.promise = (t, a) => {
              ...
              let n = Promise.resolve(t instanceof Function ? t() : t),
                ...
                i = n
                  .then(async (t) => {
                    if (((o = ["resolve", t]), e.default.isValidElement(t)))
                      ...
                      let o =
                        ...
                        n =
                          "function" == typeof a.description
                            ...
                            : a.description,
                        i =
                          "object" != typeof o || e.default.isValidElement(o) ? { message: o } : o;
                ...
                l = () =>
                  new Promise((t, e) =>
                    i.then(() => ("reject" === o[0] ? e(o[1]) : t(o[1]))).catch(e)
                  );
    ...
    let h = (t) => {
      ...
      let {
        ...
        [W, J] = e.default.useState(null),
        [G, Q] = e.default.useState(null),
        ...
        tf = e.default.useRef(S.duration || O || 4e3),
        ...
        tv = !1 !== S.dismissible,
        ty = S.className || "",
        tw = S.descriptionClassName || "",
        tx = e.default.useMemo(() => B.findIndex((t) => t.toastId === S.id) || 0, [B, S.id]),
        tE = e.default.useMemo(() => {
          var t;
          return null != (t = S.closeButton) ? t : I;
        }, [S.closeButton, I]),
        tk = e.default.useMemo(() => S.duration || O || 4e3, [S.duration, O]),
        tS = e.default.useRef(0),
        tN = e.default.useRef(0),
        tT = e.default.useRef(0),
        tM = e.default.useRef(null),
        [tC, tB] = V.split("-"),
        tj = e.default.useMemo(
          () => B.reduce((t, e, a) => (a >= tx ? t : t + e.height), 0),
          [B, tx]
        ),
        tz = (() => {
        ...
        tA = S.invert || k,
        tR = "loading" === tb;
      ((tN.current = e.default.useMemo(() => tx * U + tj, [tx, tj])),
        e.default.useEffect(() => {
          tf.current = tk;
        }, [tk]),
        e.default.useEffect(() => {
        ...
        e.default.useEffect(() => {
          ...
          if (t) {
            ...
            return (
              tc(e),
              M((t) => [{ toastId: S.id, height: e, position: S.position }, ...t]),
              () => M((t) => t.filter((t) => t.toastId !== S.id))
            );
          }
        }, [M, S.id]),
        e.default.useLayoutEffect(() => {
          ...
          ((t.style.height = e),
            tc(a),
            M((t) =>
              t.find((t) => t.toastId === S.id)
                ? t.map((t) => (t.toastId === S.id ? { ...t, height: a } : t))
                : [{ toastId: S.id, height: a, position: S.position }, ...t]
            ));
        }, [Z, S.title, S.description, M, S.id, S.jsx, S.action, S.cancel]));
        ...
        if ((!S.promise || "loading" !== tb) && S.duration !== 1 / 0 && "loading" !== S.type) {
          if (A || T || tz) {
            ...
            tf.current !== 1 / 0 &&
              ...
              (t = setTimeout(() => {
                (null == S.onAutoClose || S.onAutoClose.call(S, S), tD());
              }, tf.current)));
          return () => clearTimeout(t);
        }
      }, [A, T, S, tb, tz, tD]),
        e.default.useEffect(() => {
          S.delete && (tD(), null == S.onDismiss || S.onDismiss.call(S, S));
        }, [tD, S.delete]));
      let tI =
        S.icon ||
        (null == K ? void 0 : K[tb]) ||
      ...
      return e.default.createElement(
        "li",
        {
          ...
          className: g(
            ...
            null == S || null == (a = S.classNames) ? void 0 : a.toast,
            null == F ? void 0 : F.default,
            null == F ? void 0 : F[tb],
            null == S || null == (o = S.classNames) ? void 0 : o[tb]
          ),
          "data-sonner-toast": "",
          "data-rich-colors": null != (y = S.richColors) ? y : D,
          "data-styled": !(S.jsx || S.unstyled || N),
          "data-mounted": Z,
          ...
          style: {
            ...
            "--initial-height": X ? "auto" : `${tu}px`,
            ...P,
            ...S.style,
          },
          onDragEnd: () => {
            (to(!1), J(null), (tM.current = null));
          },
          onPointerDown: (t) => {
            2 === t.button ||
              tR ||
              ...
              "BUTTON" !== t.target.tagName &&
                (to(!0), (tM.current = { x: t.clientX, y: t.clientY })));
          },
          onPointerUp: () => {
            var t, e, a, o, r;
            if (tr || !tv) return;
            ...
            if (Math.abs(l) >= 45 || d > 0.11) {
              (td(tN.current),
                null == S.onDismiss || S.onDismiss.call(S, S),
                "x" === W ? Q(n > 0 ? "right" : "left") : Q(s > 0 ? "down" : "up"),
                tD(),
                tn(!0));
              return;
            }
          ...
          onPointerMove: (e) => {
            ...
            !W && (Math.abs(i) > 1 || Math.abs(s) > 1) && J(Math.abs(i) > Math.abs(s) ? "x" : "y");
            let d = { x: 0, y: 0 },
              ...
              "button",
              {
                ...
                onClick:
                  tR || !tv
                    ? () => {}
                    : () => {
                        (tD(), null == S.onDismiss || S.onDismiss.call(S, S));
                      },
                className: g(
                  null == F ? void 0 : F.closeButton,
                  null == S || null == (u = S.classNames) ? void 0 : u.closeButton
                ),
              },
        ...
        (tb || S.icon || S.promise) &&
          null !== S.icon &&
          ((null == K ? void 0 : K[tb]) !== null || S.icon)
          ? e.default.createElement(
              "div",
              {
                "data-icon": "",
                className: g(
                  ...
                  null == S || null == (c = S.classNames) ? void 0 : c.icon
                ),
              },
              S.promise || ("loading" === S.type && !S.icon)
                ? S.icon ||
                      ...
                      ? e.default.createElement(
                          "div",
                          {
                            className: g(
                              ...
                              null == S || null == (E = S.classNames) ? void 0 : E.loader,
                              "sonner-loader"
                            ),
        ...
        e.default.createElement(
          "div",
          {
            ...
            className: g(
              ...
              null == S || null == (f = S.classNames) ? void 0 : f.content
            ),
          },
          e.default.createElement(
            "div",
            {
              ...
              className: g(
                ...
                null == S || null == (m = S.classNames) ? void 0 : m.title
              ),
            },
            S.jsx ? S.jsx : "function" == typeof S.title ? S.title() : S.title
          ),
          S.description
            ? e.default.createElement(
                "div",
                {
                  ...
                  className: g(
                    ...
                    null == S || null == (h = S.classNames) ? void 0 : h.description
                  ),
                },
                "function" == typeof S.description ? S.description() : S.description
              )
            : null
        ),
        e.default.isValidElement(S.cancel)
          ? S.cancel
          : S.cancel && p(S.cancel)
            ? e.default.createElement(
                "button",
                {
                  ...
                  onClick: (t) => {
                    !p(S.cancel) ||
                      (tv &&
                        (null == S.cancel.onClick || S.cancel.onClick.call(S.cancel, t), tD()));
                  },
                  className: g(
                    null == F ? void 0 : F.cancelButton,
                    null == S || null == (b = S.classNames) ? void 0 : b.cancelButton
                  ),
                },
                S.cancel.label
              )
            : null,
        e.default.isValidElement(S.action)
          ? S.action
          : S.action && p(S.action)
            ? e.default.createElement(
                "button",
                {
                  ...
                  onClick: (t) => {
                    !p(S.action) ||
                      (null == S.action.onClick || S.action.onClick.call(S.action, t),
                      t.defaultPrevented || tD());
                  },
                  className: g(
                    null == F ? void 0 : F.actionButton,
                    null == S || null == (v = S.classNames) ? void 0 : v.actionButton
                  ),
                },
                S.action.label
              )
    ...
    let v = e.default.forwardRef(function (t, o) {
      let {
        ...
        B = e.default.useMemo(
          () => Array.from(new Set([s].concat(C.filter((t) => t.position).map((t) => t.position)))),
          [C, s]
        ),
        [j, z] = e.default.useState([]),
        [A, R] = e.default.useState(!1),
        [D, I] = e.default.useState(!1),
        [P, Y] = e.default.useState(
          "system" !== p
            ? p
            : "u" > typeof window &&
                window.matchMedia &&
      ...
      return (
        e.default.useEffect(
          () =>
            c.subscribe((t) => {
              t.dismiss
                ? requestAnimationFrame(() => {
                    M((e) => e.map((e) => (e.id === t.id ? { ...e, delete: !0 } : e)));
                  })
                : setTimeout(() => {
                    a.default.flushSync(() => {
                      M((e) => {
        ...
        e.default.useEffect(() => {
          let t = (t) => {
            var e, a;
            (i.every((e) => t[e] || t.code === e) && (R(!0), null == (a = $.current) || a.focus()),
              "Escape" === t.code &&
                (document.activeElement === $.current ||
                  (null == (e = $.current) ? void 0 : e.contains(document.activeElement))) &&
                R(!1));
          };
          return (
        ...
        e.default.useEffect(() => {
          if ($.current)
            return () => {
              H.current &&
                (H.current.focus({ preventScroll: !0 }), (H.current = null), (O.current = !1));
            };
        }, [$.current]),
        e.default.createElement(
          "section",
                  ...
                  "ol",
                  {
                        ...
                        "number" == typeof t || "string" == typeof t
                          ...
                          : "object" == typeof t
                            ? ["top", "right", "bottom", "left"].forEach((e) => {
                                void 0 === t[e]
                                  ? (s[`${o}-${e}`] = r)
                                  : (s[`${o}-${e}`] = "number" == typeof t[e] ? `${t[e]}px` : t[e]);
                              })
                            : n(r);
                      }),
                      s),
                    ...
                    onFocus: (t) => {
                      !(
                        ...
                        (O.current || ((O.current = !0), (H.current = t.relatedTarget)));
                    },
                    onMouseEnter: () => R(!0),
                    onMouseMove: () => R(!0),
                    onMouseLeave: () => {
  ...
  (t) => {
    ...
    let o = (t) => {
        let e,
          ...
          o = (t, o) => {
            ...
            if (!Object.is(r, e)) {
              let t = e;
              ((e = (null != o ? o : "object" != typeof r || null === r)
                ? r
                : Object.assign({}, e, r)),
                a.forEach((a) => a(e, t)));
            }
          ...
          r = (t) =>
            (function (t, e = (t) => t) {
              let o = a.default.useSyncExternalStore(
                t.subscribe,
                a.default.useCallback(() => e(t.getState()), [t, e]),
                a.default.useCallback(() => e(t.getInitialState()), [t, e])
              );
    ...
    let s = (e = (t) => ({
      ...
      error: null,
      login: async (e) => {
        let a = await (0, n.apiClient)("/api/auth/login", {
          method: "POST",
          body: JSON.stringify(e),
        });
        if (a.error || !a.data) {
          let e = a.error?.message ?? "Login failed";
          return (
            t({ error: e, isAuthenticated: !1, user: null, token: null }),
            { ok: !1, error: e }
          );
        }
        return (
          t({ user: a.data.user, token: a.data.token, isAuthenticated: !0, error: null }),
          { ok: !0 }
        );
      },
      logout: async () => {
        (await (0, n.apiClient)("/api/auth/logout", { method: "POST" }),
          t({ user: null, token: null, isAuthenticated: !1, error: null }));
      },
      hydrateSession: async () => {
        let e = await (0, n.apiClient)("/api/me");
        e.error || !e.data
          ? t({ user: null, token: null, isAuthenticated: !1, isHydrating: !1 })
          : t({
              user: e.data.user,
              token: e.data.session.token,
              isAuthenticated: !0,
              isHydrating: !1,
            });
      },
