    ...
    function m(t) {
      ...
      let D = M ? o && "object" == typeof o && o.ref : x,
        K = a.default.useCallback(
          (e) => (
            null !== $ && (P.current = (0, d.mountLinkInstance)(e, F, $, k, I, m)),
            () => {
              (P.current && ((0, d.unmountLinkForCurrentNavigation)(P.current), (P.current = null)),
      ...
      return (
        (0, f.isAbsoluteUrl)(B)
          ? (z.href = B)
          : (M && !j && ("a" !== o.type || "href" in o.props)) || (z.href = (0, p.addBasePath)(B)),
        (u = M ? a.default.cloneElement(o, z) : (0, i.jsx)("a", { ...U, ...z, children: n })),
