(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function u() {
      return !(function () {
        if ("u" < typeof window) {
          let { workUnitAsyncStorage: t } = e.r(45776),
            r = t.getStore();
          if (!r) return !1;
          switch (r.type) {
            case "prerender":
  ...
  (e, t, r) => {
    ...
    let u = e.r(51012),
      i = e.r(62175),
      c = "u" < typeof window ? e.r(69465).actionAsyncStorage : void 0;
    ...
    function s(e, t) {
      throw a(
        e,
        (t ??= c?.getStore()?.isAction ? i.RedirectType.push : i.RedirectType.replace),
  ...
  (e, t, r) => {
    ...
    ((u.ab = "/ROOT/Desktop/js project/controlroom/node_modules/next/dist/compiled/process/"),
      (t.exports = u(229)));
  },
  89283,
  (e, t, r) => {
  ...
  (e, t, r) => {
    ...
    let n = "u" < typeof window ? e.r(2201).workAsyncStorage : void 0;
    function o({ error: e }) {
      if (n) {
        let t = n.getStore();
